...
void CSnifferDlg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Control(pDX, IDC_EDIT5, m_editNHttp);
    DDX_Control(pDX, IDC_EDIT6, m_editNArp);
    DDX_Control(pDX, IDC_EDIT7, m_editIcmpv6);
    DDX_Control(pDX, IDC_EDIT8, m_editNIpv4);
    DDX_Control(pDX, IDC_EDIT9, m_editNIp);
    DDX_Control(pDX, IDC_EDIT10, m_editNOther);
    DDX_Control(pDX, IDC_EDIT11, m_editNSum);
}
...
BOOL CSnifferDlg::OnInitDialog()
{
    ...
    m_listCtrl.InsertColumn(0, _T("编号"), LVCFMT_LEFT, 50);
    m_listCtrl.InsertColumn(1, _T("时间"), LVCFMT_LEFT, 150);
    m_listCtrl.InsertColumn(2, _T("长度"), LVCFMT_LEFT, 75);
    m_listCtrl.InsertColumn(3, _T("源MAC"), LVCFMT_LEFT, 150);
    m_listCtrl.InsertColumn(4, _T("目的MAC"), LVCFMT_LEFT, 150);
    m_listCtrl.InsertColumn(5, _T("协议"), LVCFMT_LEFT, 70);
    m_listCtrl.InsertColumn(6, _T("源IP"), LVCFMT_LEFT, 150);
    m_listCtrl.InsertColumn(7, _T("目的IP"), LVCFMT_LEFT, 150);
